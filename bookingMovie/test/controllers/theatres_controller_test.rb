...
class TheatresControllerTest < ActionController::TestCase
  ...
  test "should create theatre" do
    assert_difference('Theatre.count') do
      post :create, theatre: { city: @theatre.city, name: @theatre.name, state: @theatre.state, zipcode: @theatre.zipcode }
    end
  ...
  test "should update theatre" do
    patch :update, id: @theatre, theatre: { city: @theatre.city, name: @theatre.name, state: @theatre.state, zipcode: @theatre.zipcode }
    assert_redirected_to theatre_path(assigns(:theatre))
  end
